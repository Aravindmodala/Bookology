...
from app.models.story_models import Story, Chapter, StoryWithChapters
...
class StoryService:
    ...
    async def generate_next_chapter_with_dna(
        ...
        from app.flows.generation.next_chapter_generator import NextChapterGeneratorWithDNA
    ...
    async def generate_next_chapter(self, story, previous_Chapters, selected_choice, next_chapter_number, user_id=None):
        ...
        from app.flows.generation.next_chapter_generator import NextChapterGenerator
        import asyncio
