# FIXED Generate and Save Chapter Endpoint
...
async def generate_and_save_chapter_endpoint(
    ...
    \"\"\"
    FIXED: Generate the next chapter AND save it with DNA, summaries, and vector embeddings.
    Uses the optimized service for complete feature support.
    \"\"\"
    try:
        ...
        # STEP 2: Save using optimized service 
        ...
        logger.info(f" Total time: {save_result.save_time:.2f}s")
